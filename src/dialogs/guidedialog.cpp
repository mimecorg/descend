...
GuideDialog::GuideDialog( QWidget* parent ) : QDialog( parent )
{
    ...
    action = new QAction( IconLoader::icon( "view-previous" ), tr( "Back" ), this );
    connect( action, SIGNAL( triggered() ), this, SLOT( goBack() ) );
    setAction( "goBack", action );

    action = new QAction( IconLoader::icon( "view-next" ), tr( "Forward" ), this );
    connect( action, SIGNAL( triggered() ), this, SLOT( goForward() ) );
    setAction( "goForward", action );

    action = new QAction( IconLoader::icon( "view-default" ), tr( "Home" ), this );
    ...
    promptLabel->setText( tr( "Quick guide to Descend:" ) );
